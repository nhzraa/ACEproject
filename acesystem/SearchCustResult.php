...
<title>Search Result (Customer)</title>
...
<h3 align="center"><span style="padding-center:250px">CUSTOMER DETAILS: Search Result</span></h3>
...
<h4 align="right"><span style="float:right"><span style="padding-right:150px"><a href="cust-register.php" class="btn info">+ NEW CUSTOMER</a></span></span></h4>



<br><br>
<form action="SearchCustResult.php" method="get" style="float:right; padding-right:150px">
  <span>Search Customer Status: </span>
  <input name="search" type="text" placeholder="government/private/others"> 
...
<table width="100%" class="table" align="center" >
    ...
    $sql = "select * from `customer` where `custStatus` like '%$search%' order by custStatus asc";
    ...
    while($row = mysqli_fetch_assoc($result))
	{
        ...
        Print '<tr>
				  ...
				  <td>'.$row['custStatus'].'</td>
                  <td>
                   <center>
				  <a href="cust-update.php?custID='.$row['custID'].'" class="btn update" >Update</a>
				  
				  <a href="DelCustProcess.php?custID='.$row['custID'].'" class="btn delete" >Delete</a>
