...
<title>Search Result (Supplier Pricelist: ITEM)</title>
...
<div class="content">
<h3 align="center"><br />
<span style="padding-center:250px">LIST ITEMS: SEARCH RESULT</span></h3>
...
<h4 align="right"><span style="float:right"><span style="padding-right:150px"><a href="addPL.php" class="btn info">+ ADD ITEMS</a></span></span></h4>

<br>
<br>
<form action="searchPL.php" method="get" style="float:right; padding-right:150px">
  <span>Search Supplier ID: </span>
  <input name="search" type="text" placeholder="Supplier ID"> 
...
<table width="100%" class="table" align="center" >
    ...
    $sql = "select * from `items` where `suppID` like '%$search%' order by itemsID asc";
    ...
    while($row = mysqli_fetch_assoc($result))
	{
        ...
        Print '<tr>
				 <td><center>'.$row['itemsID'].'</center></td>
				  ...
				  <td><center>'.$row['itemsPPU'].'</center></td>
				  <td><center>'.$row['itemsDisc'].'</center></td>
				  <td><center>'.$row['itemsCost'].'</center></td>
				  <td><center>'.$row['itemsMarkup'].'</center></td>
				  <td><center>'.$row['itemsDate'].'</center></td>
				  <td>
                   <center>
				  <a href="updatesuppPL.php?itemsID='.$row['itemsID'].'" class="btn update" >Update</a>
				  
				  <a href="delPL.php?itemsID='.$row['itemsID'].'" class="btn delete" >Delete</a>
