...
<div class="content">
  ...
  <form name="form1" method="post" action="addPLprocess.php" style="text-align:center">
    <p>&nbsp;</p>
...
?>
     ...
     <br />
     <label for="itemsPPU" style="float:left">Price Per Unit (RM x.xx)<span style="color:red">*</span></label>
     <input name="itemsPPU" type="decimal" style="float:right" required>
     <p>&nbsp;    </p>
     
     <label for="itemsDisc" style="float:left">Disc (x.xx%)<span style="color:red">*</span></label>
     <input name="itemsDisc" type="decimal" style="float:right" required>
     <p>&nbsp;    </p>
     
     <label for="itemsCost" style="float:left">Cost (RM x.xx)<span style="color:red">*</span></label>
     <input name="itemsCost" type="decimal" style="float:right" required>
     <p>&nbsp;    </p>
     
     <label for="itemsMarkup" style="float:left">Markup (x.xx%)<span style="color:red">*</span></label>
     <input name="itemsMarkup" value="28" type="decimal" style="float:right" required>
     <p>&nbsp;    </p>
     ...
     <p>
       ...
       <span>   <a href='supplierMenu.php' class="btn delete">Cancel</a></span></p>
     </center>
