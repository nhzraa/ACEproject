...
<title>Update Retail Pricelist</title>
...
<body>
<div class="header">
<h1 align="center" class="animate">ACID CUBIC ENTERPRISE</h1>
...
<div class="content">
  <div class="content2">
  <h2 align="center">UPDATE RETAIL PRICELIST (ITEMS)</h2>
  <form class="form-horizontal" action="updateRPprocess.php?itemsID=<?php echo $itemsID;?>" method="post">
...
?>
    ...
    <p>
      ...
      <label for="itemsRetail" style="float:left">Retail Price (RM)<span style="color:red">*</span></label>
      <input name="itemsRetail" type="decimal" style="float:right" value='<?=$row['itemsRetail'];?>' itemsRetail="itemsRetail" required><p>&nbsp;    </p>
