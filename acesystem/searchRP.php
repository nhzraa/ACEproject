...
<title>Search Result (Retail Pricelist: ITEM)</title>
...
<form action="searchRP.php" method="get" style="float:right; padding-right:150px">
  ...
  <input name="search" type="text" placeholder="pen / pencil / etc"> 
...
<table  class="table" align="center" >
    ...
    $sql = "select * from `items` where `itemsName` like '%$search%' order by itemsName asc";
