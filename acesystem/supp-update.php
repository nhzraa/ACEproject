...
<h1 align="center" class="animate">ACID CUBIC ENTERPRISE (NS-0080447-H)
  ...
  <?php
       ...
       $sql = "select * from `supplier` where `suppID` like '%$suppID%' ";
  ...
  <div class="content">
   ...
   <h2 align="center">UPDATE SUPPLIER DETAILS</h2>
  <form class="form-horizontal" action="UpdateSuppProcess.php?suppID=<?php echo $suppID;?>" method="post">
  <div class="form-group">
  
    <fieldset disabled>
     <label for="suppID" style="float:left">Supplier ID<span style="color:red">*</span></label>
      <input name="suppID" type="varchar" required class="form-control" style="float:right" value='<?=$row['suppID'];?>' size="12" suppID="suppID"></label>
      <br><br>
    </fieldset>
      <br><br>
      
      <label for="suppName">Name:
     <input class="form-control" type="varchar" name="suppName" value='<?=$row['suppName'];?>' suppName="suppName" style="float:right"></label>
     <p>&nbsp;    </p> 
     
      <label for="suppPhone" style="float:left">Phone<span style="color:red">*</span></label>
      <input name="suppPhone" type="varchar" required class="form-control" style="float:right" value='<?=$row['suppPhone'];?>' size="14" suppPhone="suppPhone"></label>
      <br><br>
      
      <label for="suppMail" style="float:left">Email<span style="color:red">*</span></label>
      <input name="suppMail" type="varchar" required class="form-control" style="float:right" value='<?=$row['suppMail'];?>' size="45" suppMail="suppMail"></label>
      <br><br>
      <label for="suppFax" style="float:left">Fax<span style="color:red">*</span></label>
      <input name="suppFax" type="varchar" required class="form-control" style="float:right" value='<?=$row['suppFax'];?>' size="14" suppFax="suppFax"></label>
      <br><br>
      
        <label for="suppAdd" style="float:left">Address<span style="color:red">*</span></label>
        <textarea required class="form-control" name="suppAdd" suppAdd="suppAdd" cols="35" style="float:right"><?php echo $row['suppAdd'];?></textarea></label>
      <br><br>
      <p><br>
  </p>
      <center>
      ...
      <span>   <a href='SearchSuppResult.php?search=&btnsearch=GO' class="btn delete">Cancel</a></span></p>
    <p>&nbsp;</p>
</center>
  </form>
 </div>
